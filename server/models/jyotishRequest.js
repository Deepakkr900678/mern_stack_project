...
const JyotishRequestSchema = new mongoose.Schema({
...
JyotishRequestSchema.methods.jwtToken = function () {
  return jwt.sign({ id: this._id }, process.env.JWT_SECRET, { expiresIn: "10d" });
};

const JyotishRequest = mongoose.model('JyotishRequest', JyotishRequestSchema);

module.exports = JyotishRequest;